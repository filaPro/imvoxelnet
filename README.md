...
**News**:
 * :cry: June, 2025. Original repo was deleted from `SamsungLabs/imvoxelnet`. Please follow [mmdetection3d](https://github.com/open-mmlab/mmdetection3d/tree/master/configs/imvoxelnet) for the trained checkpoints.
